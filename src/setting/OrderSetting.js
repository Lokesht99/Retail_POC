...
//     deliveryRegions: [],
//     payments: [],
//     deliveryFees: [], // Ensure this is initialized
//   });
...
//         ...orderSetting,
//         ...setting.payload,
//         deliveryFees: setting.payload.deliveryFees || [],
//         payments: setting.payload.payments || [],
//       });
//     }
//   }, [setting]);
...
//       let errors = {};
//       if (values.minimumOrderLimitPerProduct < 1) {
//         errors.minimumOrderLimitPerProduct = "Must be greater than or equal 1.";
//       }
//       return errors;
//     },
//     validateOnBlur: false,
...
//     let list = [...formik.values.deliveryFees];
//     list.splice(i, 1);
//     formik.setFieldValue("deliveryFees", list);
//   }

//   return (
//     <div>
//       <Modal
//         title={payment.index === -1 ? "Add Delivery Fees" : "Edit Delivery Fees"}
//         isOpen={showDialog}
//       >
//         <PaymentEditDialog
//           payment={payment.data}
...
//                     value={formik.values.minimumOrderLimitPerProduct}
//                     onChange={formik.handleChange}
//                     error={formik.errors.minimumOrderLimitPerProduct}
//                   />
//                 </div>
//                 <div>
//                   <div className="flex items-center mt-5 mb-2">
...
import { parseError } from "../common/utils";
import PaymentEditDialog from "./PaymentEditDialog";
import { getOrderSetting, saveOrderSetting,deletePayment } from "./SettingRepo";
...
function OrderSetting() {
  ...
  const [deleteState, requestDeletePayment] = useAPIRequest(deletePayment);
  ...
  async function removePayment(paymentId, index) {
    try {
      await requestDeletePayment(paymentId);
      const updatedPayments = formik.values.payments.filter((_, i) => i !== index);
  ...
  return (
    <div>
      <Modal
        title={payment.index === -1 ? "Add Payment" : "Edit Payment"}
        isOpen={showDialog}
      >
        <PaymentEditDialog
          payment={payment.data}
          list={formik.values.payments}
          index={payment.index}
          handleClose={(value) => {
            setShowDialog(false);
            if (value && value.length !== 0) {
